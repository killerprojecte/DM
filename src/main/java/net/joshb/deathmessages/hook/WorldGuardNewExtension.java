...
public class WorldGuardNewExtension {
    ...
    public static final StateFlag BROADCAST_ENTITY;
    ...
    static {
        ...
        BROADCAST_ENTITY = new StateFlag("broadcast-deathmessage-entity", true);
    }

    public WorldGuardNewExtension() {
